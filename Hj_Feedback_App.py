...
"Japanese - Japan":"ja_JP","Korean - Korea":"ko_KR","Turkish - Turkey":"tr_TR", "English - United Kingdom":"en_GB"}
...
if date_df.empty == True:
    ...
    histfig = px.histogram(date_df, x='Date Submitted', color='Emotion (1-5)',
        ...
        color_discrete_map={1:"#E45756", 2:"#F58518", 3:"#BAB0AC", 4:"#72B7B2", 5:"#54A24B"},
        nbins=20
    )
...
cfsb = st.text_input("Enter a country here")
